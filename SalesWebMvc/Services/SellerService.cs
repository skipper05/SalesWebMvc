...
namespace SalesWebMvc.Services // Essa Classe cria serviços para a classe Sellers 
{
    public class SellerService
    {
        ...
        {
            return await _context.Seller.Include(obj => obj.Department).FirstOrDefaultAsync(obj => obj.Id == id); //O include faz parte da bibliotec Microsoft.EntityFrameworkCore
